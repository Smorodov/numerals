...
CText towords(long long int numb)
{
    ...
    std::vector < std::vector<CText> > pwrs = {
    {_T("тысяч") ,_T("миллионов"),_T("миллиардов"),_T("триллионов")},
    {_T("тысяча"),_T("миллион")  ,_T("миллиард")  ,_T("триллион")  },
    {_T("тысячи"),_T("миллиона") ,_T("миллиарда") ,_T("триллиона") },
    {_T("тысячи"),_T("миллиона") ,_T("миллиарда") ,_T("триллиона") },
    {_T("тысячи"),_T("миллиона") ,_T("миллиарда") ,_T("триллиона") },
    {_T("тысяч") ,_T("миллионов"),_T("миллиардов"),_T("триллионов")},
    {_T("тысяч") ,_T("миллионов"),_T("миллиардов"),_T("триллионов")},
    ...
    //массив окончаний
   std::vector < std::vector<CText> > termination;
   for (int i = 0; i < pwrs[0].size()*3+1; ++i)
   {
       std::vector<CText> v(9, CText(_T("")));
    ...
    while (n1)
    {
        ...
        if (!(cnt % 3))
        {
            result = result + termination[cnt][celoe];
            result = result + _T(" ");
        }
    }
